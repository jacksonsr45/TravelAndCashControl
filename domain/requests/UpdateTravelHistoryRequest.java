...
public class UpdateTravelHistoryRequest {
    private String id;
    ...
    public UpdateTravelHistoryRequest(String id, String monthHistoryID, Date date, String commit, Double collect, Double deliver, Double complement, Double deposit, Double withdrawals, Double devolution, Double spent) {
        this.id = id;
