...
public abstract class UpdateTravelHistoryFactory {
    ...
    public UpdateTravelHistoryFactory(TravelHistoryInterface repository, UpdateTravelHistoryRequest request) {
